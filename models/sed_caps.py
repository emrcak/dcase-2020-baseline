...
from modules import Decoder, Decoder_sed

__author__ = 'Emre Cakir'
__docformat__ = 'reStructuredText'
__all__ = ['SEDCaps']


class SEDCaps(Module):
    ...
    def __init__(self,
        ...
        self.decoder_sed: Module = Decoder_sed(
            input_dim=output_dim_encoder * 2,
            output_dim=output_dim_h_decoder,
            nb_classes=nb_classes,
            dropout_p=dropout_p_decoder)
    ...
    def forward(self,
        ...
        return self.decoder(h_encoder), self.decoder_sed(h_encoder)
